  ...
  return (
      <div className="contratoContainer" id="hrefcontrato">
        ...
        <p>
          ...
          los conectamos con las empresas que los necesitan. Cada modalidad de
          contratación puede ser adaptada a las necesidades y requerimientos
          específicos de cada cliente, lo que asegura un servicio personalizado
          y de calidad. Además, el equipo de reclutamiento se encarga de brindar
          un soporte y seguimiento continuo a cada cliente, lo que garantiza su
          satisfacción y éxito a largo plazo.
        </p>
        <div className="contratoItems">
